...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/canvas-api
```

A live public deployment of this template is available at [https://canvas-api.templates.workers.dev](https://canvas-api.templates.workers.dev)
